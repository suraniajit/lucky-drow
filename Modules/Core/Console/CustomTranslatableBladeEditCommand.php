...
class CustomTranslatableBladeEditCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-translatable-blade-edit';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . '/Resources/views/backend/edit.blade.php';
    }
    ...
    private function getStubName()
    {
        ...
        $stub = '/views/backend/translatable_edit.stub';
