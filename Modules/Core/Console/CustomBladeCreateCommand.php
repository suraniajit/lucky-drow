...
class CustomBladeCreateCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-blade-create';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . '/Resources/views/backend' . '/' . $this->argument('lower_name') . '/create.blade.php';
    }
    ...
    private function getStubName()
    {
        ...
        $stub = '/views/backend/folder-create.stub';
