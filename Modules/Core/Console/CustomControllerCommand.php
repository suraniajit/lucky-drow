...
class CustomControllerCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-controller';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . '/Http/Controllers/Backend' . '/' . $this->getControllerName() . 'Controller.php';
    }
    /**
    ...
    private function getStubName()
    {
        ...
        $stub = '/scaffold/folder-controller.stub';
