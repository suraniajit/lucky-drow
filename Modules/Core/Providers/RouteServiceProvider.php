...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $backendModuleNamespace = 'Modules\Core\Http\Controllers\Backend';
    protected $frontendModuleNamespace = 'Modules\Core\Http\Controllers\Frontend';
    protected $apiModuleNamespace = 'Modules\Core\Http\Controllers\Api';
