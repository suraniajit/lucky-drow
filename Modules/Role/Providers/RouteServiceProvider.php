...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $backendModuleNamespace = 'Modules\Role\Http\Controllers\Backend';
    protected $frantendModuleNamespace = 'Modules\Role\Http\Controllers\Frantend';
    protected $apiModuleNamespace = 'Modules\Role\Http\Controllers\Api';
